...
var Route$2 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{ title: "Squeeze — Premium Cold-Pressed Juices" },
			{
				name: "description",
				content: "Premium cold-pressed juices made from real fruit, in a vibrant interactive 3D experience. Fresh, playful, delivered fast."
			},
			{
				name: "author",
				content: "Squeeze Juice Co."
			},
			{
				property: "og:title",
			...
			},
			{
				...
				content: "Vibrant cold-pressed juices from real fruit. Fresh, playful, delivered fast."
			},
			{
				property: "og:type",
				content: "website"
...
var Route = createFileRoute("/")({
	head: () => ({ meta: [
		...
		{
			name: "description",
			content: "Squeeze crafts premium cold-pressed juices from real fruit. Explore a vibrant interactive 3D experience and order refreshing blends delivered to your door."
		},
		{
			property: "og:title",
			content: "Squeeze — Premium Cold-Pressed Juices"
		...
		{
			property: "og:description",
			content: "Vibrant, cold-pressed juices made from real fruit. Fresh, playful, and delivered fast."
		},
		{
			property: "og:type",
			content: "website"
