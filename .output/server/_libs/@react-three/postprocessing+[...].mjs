...
import { B as PerspectiveCamera, C as FloatType, D as LinearFilter, I as MeshNormalMaterial, L as NearestFilter, P as Mesh, S as EventDispatcher, X as Scene, Y as SRGBColorSpace, Z as ShaderMaterial, at as UnsignedByteType, b as DepthTexture, c as BufferGeometry, ct as Vector3, dt as init_performance, f as Color, ft as performance_default, it as Uniform, j as Material, k as LinearSRGBColorSpace, lt as Vector4, nt as Texture, o as BasicDepthPacking, ot as UnsignedInt248Type, s as BufferAttribute, st as Vector2, ut as WebGLRenderTarget, w as HalfFloatType, y as DepthStencilFormat, z as OrthographicCamera } from "../@monogrid/gainmap-js+[...].mjs";
import { n as require_react } from "../@radix-ui/react-compose-refs+[...].mjs";
import { c as extend, d as useThree, l as useFrame, p as require_jsx_runtime } from "./drei+[...].mjs";
...
var Timer = class {
	...
	*/
	constructor() {
		this.startTime = performance_default.now();
		this.previousTime = 0;
		this.currentTime = 0;
		this._delta = 0;
		this._elapsed = 0;
	...
	*/
	update(timestamp) {
		if (this.useFixedDelta) this._delta = this.fixedDelta;
			...
			this.currentTime = (timestamp !== void 0 ? timestamp : performance_default.now()) - this.startTime;
	...
	*/
	reset() {
		this._delta = 0;
		this._elapsed = 0;
		this.currentTime = performance_default.now() - this.startTime;
	}
	getDelta() {
		return this.delta;
	}
	...
	handleEvent(e) {
		if (!document.hidden) this.currentTime = performance_default.now() - this.startTime;
	}
	dispose() {
...
}), wt = /*@__PURE__*/ P(BloomEffect, { blendFunction: 0 }), qt = /*@__PURE__*/ P(VignetteEffect);
//#endregion
export { wt as i, dt as n, qt as r, ce as t };
